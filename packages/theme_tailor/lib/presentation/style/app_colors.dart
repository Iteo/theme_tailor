...
abstract class AppColors {
  const AppColors({
    ...
    required this.additional1opacity10,
    required this.additional2,
    required this.additional3,
    required this.additional4,
    required this.additional4opacity10,
    required this.additional5,
    required this.additional5opacity10,
    required this.additional6,
    required this.additional6opacity10,
    required this.additional7,
    required this.additional7opacity10,
    required this.additional8,
    required this.additional8opacity10,
    required this.additional9,
    required this.additional9opacity10,
    ...
    required this.primaryButtonClickedopacity10,
...
class LightAppColors extends AppColors {
  const LightAppColors()
      : super(
          additional1: const Color(0xFF98C93C),
          additional1opacity10: const Color(0x1A98C93C),
          additional2: const Color(0xFFEC0677),
          additional3: const Color(0xFF70AE09),
          additional4: const Color(0xFFF0771F),
          additional4opacity10: const Color(0x1AF0771F),
          additional5: const Color(0xFF55B8D8),
          additional5opacity10: const Color(0x1A55B8D8),
          additional6: const Color(0xFF25B422),
          additional6opacity10: const Color(0x1A25B422),
          additional7: const Color(0xFF5591D8),
          additional7opacity10: const Color(0x1A5591D8),
          additional8: const Color(0xFFAE55D8),
          additional8opacity10: const Color(0x1AAE55D8),
          additional9: const Color(0xFF22B490),
          additional9opacity10: const Color(0x1A22B490),
          ...
          error: const Color(0xFFEF404A),
          erroropacity10: const Color(0x1AEF404A),
          ...
          primaryButtonClicked: const Color(0xFFF6B409),
          primaryButtonClickedopacity10: const Color(0x1AF6B409),
...
class DarkAppColors extends AppColors {
  const DarkAppColors()
      : super(
          ...
          overlay: const Color(0x73000000),
          primary: const Color(0xFFFFCD00),
          primaryButtonClicked: const Color(0x1AF6B409),
          primaryButtonClickedopacity10: const Color(0x1AF6B409),
          subtypo: const Color(0xFF929497),
